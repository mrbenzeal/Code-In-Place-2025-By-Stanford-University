Write a program that has the user play a word guessing game. 

link: https://codeinplace.stanford.edu/cip5/ide/a/wordguessing

You'll use variables, strings, lists, and file reading.
Here is an example where the player tries to guess a secret word one letter at a time:
